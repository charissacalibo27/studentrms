    ...
    <div style="display:flex; flex-direction: column;">
        ...
        <div class="btn-group" role="group" aria-label="Basic outlined example" style="margin-block: 1%; width:auto">
            <?php while ($rows = mysqli_fetch_assoc($result)) { ?>
                ...
                <button id="btn-in-grade" type="button" class="btn btn-outline-primary btn-in-grade"
                    data-session="<?php echo strtoupper($rows['session']) ?>"
                    data-company="<?php echo strtoupper($rows['comp']) ?>"><?php echo strtoupper($rows['comp']) ?></button>
        ...
        <div style="width: 20%;">
            <select class="select-semester form-select" aria-label="Default select example">
                ...
                <option value="1" data-get_sem="1">First sem</option>
